...
<img src="/images/praxis-planner-mockup.png" loading="lazy" alt="Praxis Planner Page">
...
<img src="/images/praxis-training-mockup.png" loading="lazy" alt="Praxis Training Page">
...
<div style="font-size: 14px; margin-top: 8px; margin-bottom: 24px; padding: 8px 16px; line-height: 1.4; text-align: center; border: 1px solid currentColor; border-radius: 16px;">Integrated documentation portal offering quick access to tools, updates, and compliance standards to streamline daily operations.</div>
<img src="/images/praxis-documentation-mockup.png" loading="lazy" alt="Praxis Documentation Page">
